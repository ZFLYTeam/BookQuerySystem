...
<body>
    ...
    <div class="form-signin">
        <h2 class="form-signin-heading" align="center">
            登录 ZFLY</h2>
        <asp:TextBox ID="txtUserName" class="input-block-level" placeholder="请输入用户名" runat="server"></asp:TextBox>
        <asp:TextBox ID="txtPassword" class="input-block-level" placeholder="请输入密码" runat="server" TextMode="Password"></asp:TextBox>
